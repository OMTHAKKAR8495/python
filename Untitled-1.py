    ...
    with open("primes_output.txt", "w") as f:
        ...
        for num in range(2, limit + 1):
            if is_prime(num):
                ...
                f.write(f"{num}\n")
            if num % 100000 == 0:
                print(f"Checked up to: {num} numbers...")
                time.sleep(0.5)  # simulate delay for each 100k numbers
    end_time = time.time()
...
if __name__ == "__main__":
    print("Starting heavy prime number generator...")
    # Set a large number to make it slow and intensive (can reduce if needed)
    generate_primes(10**7)  # Try 10**8 or 10**9 for longer time
...
str1="my self om"
len1=len(str1)
str2="i am in gsfc college"
len2=len(str2)
str3="i am studying btech cse in gsfc college"
len3=len(str3)
